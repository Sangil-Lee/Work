...
int NoWaitQueueTest_init(void)
{
	printk("NoWaitQueueTest Module id Loaded ....\n");
...
void NoWaitQueueTest_exit(void)
{
	if(task1) {
	...
	printk("NoWaitQueueTest Module is Unloaded ....\n");
}

module_init(NoWaitQueueTest_init);
module_exit(NoWaitQueueTest_exit);
