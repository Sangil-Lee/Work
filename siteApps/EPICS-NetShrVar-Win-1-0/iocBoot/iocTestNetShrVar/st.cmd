...
#NetShrVarConfigure("nsv", "sec1", "F:/epics/7.0.3/siteApps/Ctrl_IOC/EPICS-NetShrVar-Win-1-0/TestNetShrVarApp/src/netvarconfig.xml", 1000, 0)

## Load our record instances

## Basic network shared variable access.
dbLoadRecords("db/TestNetShrVar.db","P=TEST:")
dbLoadRecords("db/control.vdb", "P=TEST")
