...
/* Generated from ../O.Common/liquifier.dbd */
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"liquifier_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    liquifier_registerRecordDeviceDriver(*iocshPpdbbase);
}
