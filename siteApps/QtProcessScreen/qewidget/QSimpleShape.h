...
public:
   ...
   enum Shapes { noShape, circle, ellipse, rectangle, roundRectangle, roundSquare, square,
                 ...
                 roundpie, pie, heart, valve_h, valve_v, con_valve_h, pump, crosspump, rectcorner };
   Q_ENUMS (Shapes)
   ...
   Q_PROPERTY (int    cornerWidth   READ getCornerWidth   WRITE setCornerWidth)
...
public:
   ...
   void setCornerWidth (const int value);
