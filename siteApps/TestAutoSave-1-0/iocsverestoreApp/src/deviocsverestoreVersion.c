...
#include "iocsverestoreVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = iocsverestoreVERSION;
...
static lsidset deviocsverestoreVersion = {
	{5, NULL, NULL, NULL, NULL}, read_string
};
epicsExportAddress(dset,deviocsverestoreVersion);
