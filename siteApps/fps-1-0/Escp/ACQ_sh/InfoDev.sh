...
export ipAddr=192.168.3.67
export macAddr=00:0A:35:00:1E:67
export BID_value=AN67
export LINK=6
export NODE=7
export TARGET=67
export BoardType=AN
...
echo "Dev Password              ---> #######"
TR_BID_value=`echo ${BID_value} | tr '[a-z]' '[A-Z]'`	# 소문자를 대문자로
