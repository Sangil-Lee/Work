...
*    ContRTD-IntClk-SCXI1102+1581.c
*
* Example Category:
*    AI
*
* Description:
*    This example demonstrates how to acquire temperature data from
*    an RTD using the DAQ device's internal clock. This example uses
*    the SCXI 1102 module in conjuction with the SCXI 1581 module.
*
...
int main(void)
{
	...
	DAQmxErrChk (DAQmxCreateAIRTDChan(taskHandle,"SC1Mod1/ai0","",0.0,100.0,DAQmx_Val_DegC,DAQmx_Val_Pt3750,DAQmx_Val_4Wire,DAQmx_Val_External,0.00010,100.0));
