...
drvModbusAsynConfigure("KoBRAAI", "SLITPLC", 0, 6,  0,   32,  7, 100, "Modicon")
drvModbusAsynConfigure("KoBRAAO", "SLITPLC", 0, 6,  128, 122, 7, 100, "Modicon")
drvModbusAsynConfigure("KoBRADI", "SLITPLC", 0, 3,  256, 4,   7, 100, "Modicon")
drvModbusAsynConfigure("KoBRADO", "SLITPLC", 0, 6,  260, 4,   7, 100, "Modicon")
