...
/* Generated from ../O.Common/iocex2.dbd */
...
int iocex2_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/ctrluser/epics/7.0.6.1/siteApps/Training/Ex2";
...
/* iocex2_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"iocex2_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(iocex2_registerRecordDeviceDriver(*iocshPpdbbase));
}
