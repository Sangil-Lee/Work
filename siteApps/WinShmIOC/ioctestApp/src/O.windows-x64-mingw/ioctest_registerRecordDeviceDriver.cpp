...
/* Generated from ../O.Common/ioctest.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devioctestVersion, *pvar_dset_devLsoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devioctestVersion", "devLsoSoft", "devLsoSoftCallback",
...
int ioctest_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "C:/epics/7.0.6.1/siteApps/Ctrl_IOC/TestIOC";
...
/* ioctest_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"ioctest_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(ioctest_registerRecordDeviceDriver(*iocshPpdbbase));
}
