...
static FieldMapCurrent fieldmapcurrentHWR("./bptHWRHI");
static FieldMapCurrent fieldmapcurrentQWRO("./bptQWROLDHI");
static FieldMapCurrent fieldmapcurrentQWRN("./bptQWRNEWHI");
