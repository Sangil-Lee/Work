#ifndef		_LVFPGA_ASYN_EPICS_H
#define		_LVFPGA_ASYN_EPICS_H
...
class lvfpgaAsynEpics : public asynPortDriver 
{
public:
	lvfpgaAsynEpics(const char *portName, const char* filename, const char* bitfile, const char* resource);
	void UserProcess();
...
private:
	...
	shared_ptr<lvfpga::lvfpgaDriver> pLVFPGA;
