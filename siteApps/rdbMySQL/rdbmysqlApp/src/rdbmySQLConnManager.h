...
private:
	...
	SQL_FILDA, SQL_FILDB, SQL_FILDC, SQL_FILDD, SQL_FILDE, SQL_FILDF, SQL_FILDG, SQL_FILDH, SQL_FILDI, SQL_FILDJ, SQL_FILDK, 
	SQL_FILDL, SQL_FILDM, SQL_FILDN, SQL_FILDO, SQL_FILDP, SQL_FILDQ, SQL_FILDR, SQL_FILDS, SQL_FILDT, SQL_FILDU, SQL_FILDV,
	SQL_FILDW, SQL_FILDX, SQL_FILDY, SQL_FILDZ };
