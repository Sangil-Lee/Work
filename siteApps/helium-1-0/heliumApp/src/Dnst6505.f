C This is a program to calculate the density of GHe in the impure tanks.
C The following assignments are required.
C
      Real*8 function Dnst6505(Temp, Press)
			REAL*8 Temp, Press
...
C JIN1 is an input variable for the temperature of GHe in the impure tanks.
C JIN2 is an input variable for the pressure of GHe in the impure tanks.
...
C
C Note: PROP(3,j) is the density of GHe in the impure tanks. 
C
...
C the output data is inputted into the result variable, "Dnst6505".
C
	   Dnst6505 = PROP(3,0)
C
C Print selected results after a successful calculation for test. 
C 
C         WRITE (1, 10) Dnst6505, IDID
      ELSE
C
...
C the Dnst6505 will be zero for EPICS to notice the failure.
C
	   Dnst6505 = 0
      ENDIF
