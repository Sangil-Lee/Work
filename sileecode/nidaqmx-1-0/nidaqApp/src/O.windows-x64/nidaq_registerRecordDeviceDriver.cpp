...
static const char * const deviceSupportNames[] = {
    ...
    "asynLoInt32", "asynLoUInt32Digital", "devLsiSoft", "devLsiEnviron",
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_nidaqAsynEpicsRegister, pvar_func_rsrvRegistrar,
...
int nidaq_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "C:/home/cdms/epics/7.0.7/siteApps/Ctrl_IOC/nidaqmx-1-0";
    ...
    runRegistrarOnce(pvar_func_nidaqAsynEpicsRegister);
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: nidaq_registerRecordDeviceDriver pdbbase\n",
};
