...
public class SeverityPVHandler
{
    ...
    private static void performUpdates()
    {
		...
		try {
				print = new PrintStream("alarm-server_performUpdates_log.txt");
				System.setOut(print);
		...
		logger.info("=================>updates isEmpty<==============" + updates.isEmpty());
        ...
        for (String pv_name : updates.keySet())
        {
            ...
            try
            {
                ...
                if (pv != null)
				{
					System.out.println("Count:("+count+"), Item PV: " + pv_name + ", Severity: " + severity.name() +"PVString: " + pv.toString());
