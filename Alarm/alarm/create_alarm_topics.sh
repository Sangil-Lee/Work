...
for topic in "$1"
do
    kafka/bin/kafka-topics.sh  --bootstrap-server 192.168.75.201:9092 --create --replication-factor 1 --partitions 1 --topic $topic
    kafka/bin/kafka-configs.sh --bootstrap-server 192.168.75.201:9092 --entity-type topics --alter --entity-name $topic \
