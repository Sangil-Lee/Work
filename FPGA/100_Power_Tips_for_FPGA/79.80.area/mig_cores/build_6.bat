cd mig_v3_4_high_freq\example_design_experiment_6\par
...
map -intstyle ise -p xc6vlx75t-ff484-2 -detail -w -ol high -xe n -register_duplication off -global_opt on -ir off -pr off -lc off -power off -o example_top_map.ncd example_top.ngd example_top.pcf >> ise_flow_results.txt
echo done!
