# 
# Project automation script for crc 
# 
# Created for ISE version 12.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source crc.tcl), then you can
...
proc set_process_props {} {
   ...
   project set "Project Description" "crc example"
   ...
   project set "Slice Utilization Ratio" "100"
   ...
   project set "Work Directory" "H:/fpga_book/src/crc_example/ise_proj/xst" -process "Synthesize - XST"
   ...
   project set "Custom Project Filename" "" -process "Post-Map Check Syntax"
   project set "Custom Project Filename" "" -process "Post-Place & Route Check Syntax"
   project set "Custom Project Filename" "" -process "Post-Translate Check Syntax"
   ...
   project set "Output File Name" "" -process "Generate IBIS Model"
