/*************************************************************************\
 * snmpDevAsync.c - Record Support Routines for SNMP record 
 *
...
long snmp_Write(void *precord)
{
  ...
  /* if( (psnmp->rval == psnmp->oval) && (psnmp->rval != 3) ) return 2;   //leesi */
  ...
  sprintf(snmpinfo->sval, "%ld", (long)psnmp->val); //leesi
