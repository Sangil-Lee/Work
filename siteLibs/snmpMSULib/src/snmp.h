...
#endif
    /*
     * Definitions for the Simple Network Management Protocol (RFC 67).
     *
     *
     */
/***********************************************************
...
#define SNMP_MAX_LEN        15        /* typical maximum message size */
...
235 #define SNMP_VALIDATE_ERR(x)  ( (x > MAX_SNMP_ERR) ? \
                                   SNMP_ERR_GENERR : \
                                   (x < SNMP_ERR_NOERROR) ? \
                                      SNMP_ERR_GENERR : \
                                      x )
...
#define SNMP_MSG_FLAG_RPRT_BIT          0x04
     ...
     */
#define UCD_MSG_FLAG_RESPONSE_PDU            0x1
#define UCD_MSG_FLAG_EXPECT_RESPONSE         0x2
#define UCD_MSG_FLAG_FORCE_PDU_COPY          0x4
#define UCD_MSG_FLAG_ALWAYS_IN_VIEW          0x8
#define UCD_MSG_FLAG_PDU_TIMEOUT            0x1
#define UCD_MSG_FLAG_ONE_PASS_ONLY          0x2
#define UCD_MSG_FLAG_TUNNELED               0x4
